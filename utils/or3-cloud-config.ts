...
const DEFAULT_OR3_CLOUD_CONFIG: Or3CloudConfig = {
    ...
    admin: {
        ...
        pluginRuntimeShadowEnabled: true,
...
const cloudConfigSchema = z.looseObject({
    ...
    storage: z.object({
        ...
        allowAnyFileType: z.boolean().optional(),
    ...
    admin: z
        .object({
            ...
            pluginModuleLoaderV2Enabled: z.boolean().optional(),
            pluginModuleLoaderV2WorkspaceIds: z.array(z.string().min(1)).optional(),
            pluginIsolationEnabled: z.boolean().optional(),
