 ...
 * Generated: 2025-11-07T03:17:43.052Z
 */
...
export type ThemeIdentifier =
    ...
    | 'dashboard.export'
    | 'dashboard.import'
    | 'dashboard.ai.save-prompt'
    | 'dashboard.ai.model-mode'
    | 'dashboard.ai.model-item'
    | 'dashboard.ai.clear-model'
    | 'dashboard.ai.reset'
    | 'dashboard.theme.mode'
    | 'dashboard.theme.preset'
    | 'dashboard.theme.remove-layer'
    | 'dashboard.theme.repeat'
    | 'dashboard.theme.gradient'
    | 'dashboard.theme.reset-all'
    | 'dashboard.workspace.export'
    | 'dashboard.workspace.browse'
    | 'dashboard.workspace.clear-file'
    | 'dashboard.workspace.import-mode'
    | 'dashboard.workspace.import'
    | 'dashboard.back'
    | 'dashboard.landing-page'
    | 'dashboard.plugin-icon'
    | 'dashboard.ai.model-search'
    | 'document.toolbar'
    | 'document.search'
    | 'document.retry'
    | 'document.search-retry'
    | 'document.title'
