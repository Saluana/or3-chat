 ...
 * Generated: 2025-11-26T14:26:32.832Z
 */
...
export type ThemeIdentifier =
    ...
    | 'ui.glass-button'
    | 'sidebar.project-group-container'
    | 'sidebar.new-chat'
    | 'sidebar.thread-rename'
    | 'sidebar.thread-add-to-project'
    | 'sidebar.thread-delete'
    | 'sidebar.thread-extra-action'
    | 'sidebar.document-rename'
    | 'sidebar.document-add-to-project'
    | 'sidebar.document-delete'
    | 'sidebar.document-extra-action'
    | 'sidebar.project-rename'
    | 'sidebar.project-delete'
    | 'sidebar.project-extra-action'
    | 'sidebar.bottom-nav.info'
    | 'sidebar.bottom-nav.dashboard'
    | 'sidebar.bottom-nav.activity'
    | 'sidebar.bottom-nav.credits'
    | 'dashboard.back'
    | 'sidebar.toggle'
    | 'dashboard.theme.copy-color'
