 ...
 * Generated: 2025-11-06T18:10:29.444Z
 */
 ...
 */
export type ThemeIdentifier = 'chat.send' | 'sidebar.toggle' | 'sidebar.filter' | 'sidebar.search' | 'chat.stop' | 'chat.attach' | 'chat.settings' | 'chat.editor' | 'message.copy' | 'message.retry' | 'message.branch' | 'message.edit' | 'dashboard.export' | 'dashboard.import' | 'document.toolbar' | 'document.search';
