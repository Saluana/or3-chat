...
declare module '#app' {
    interface NuxtApp {
        $theme: {
            ...
            getResolver: (themeName: string) => import('~/theme/_shared/runtime-resolver').RuntimeResolver | null;
            loadCompiledTheme: (themeName: string) => Promise<import('~/theme/_shared/types').CompiledTheme | null>;
        };
