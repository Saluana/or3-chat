...
export function buildApplyOnlySuccessBody(): string {
    return `Your .env and provider modules were written. Start the app with ${START_APP_COMMAND} (or bun start) when you are ready.`;
}
