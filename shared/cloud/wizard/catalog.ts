        ...
        fields: [
            {
                key: 'sqliteDbPath',
                type: 'text',
                label: 'Sync SQLite DB Path',
                required: true,
            },
            {
                key: 'sqlitePragmaJournalMode',
                type: 'text',
                label: 'SQLite PRAGMA journal_mode',
                defaultValue: 'WAL',
            },
            {
                key: 'sqlitePragmaSynchronous',
                type: 'text',
                label: 'SQLite PRAGMA synchronous',
                defaultValue: 'NORMAL',
            },
            {
                key: 'sqliteAllowInMemory',
                type: 'boolean',
                label: 'Allow in-memory DB in non-test env',
                defaultValue: false,
            },
            {
                key: 'sqliteStrict',
                type: 'boolean',
                label: 'Strict SQLite mode',
                defaultValue: false,
            },
        ],
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                type: 'password',
                label: 'Convex Self-hosted Admin Key (optional)',
                secret: true,
            },
        ],
    },
        ...
        fields: [
            {
                key: 'fsRoot',
                type: 'text',
                label: 'FS Storage Root (absolute path)',
                required: true,
            },
            {
                key: 'fsTokenSecret',
                type: 'password',
                label: 'FS Token Secret',
                required: true,
                secret: true,
            },
            {
