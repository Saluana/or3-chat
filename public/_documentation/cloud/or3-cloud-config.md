...
| `admin.pluginModuleLoaderV2Enabled` (`OR3_PLUGIN_MODULE_LOADER_V2_ENABLED`)   | `false` | Enables selected digest-addressed package assets and server modules; this does not connect the standard installer to V2 promotion                                    |
