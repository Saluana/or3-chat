...
- [ ] 1.3 Add typed density and elevation fields to the theme and override contracts
...
- [ ] 1.4 Add the focus, motion, and elevation CSS token fallbacks
...
- [ ] 2.1 Implement pure density and elevation preset mappers
...
- [ ] 2.2 Apply and remove density overrides through `applyMergedTheme`
...
- [ ] 2.3 Apply and remove elevation overrides through `applyMergedTheme`
...
- [ ] 2.4 Implement the versioned global accessibility preference store
...
- [ ] 2.5 Apply focus and motion accessibility preferences to the root element
...
- [ ] 3.1 Migrate shared Nuxt UI controls and base application config
...
- [ ] 3.2 Migrate sidebar and workspace navigation controls
...
- [ ] 3.3 Migrate chat, document, and workflow toolbars
...
- [ ] 3.4 Migrate dashboard, admin, wizard, and plugin-facing first-party controls
...
- [ ] 4.1 Migrate base focus-visible rules and Nuxt UI mappings
...
- [ ] 4.2 Migrate custom interactive components by application area
...
- [ ] 4.3 Verify keyboard focus contrast in every shipped theme
...
- [ ] 5.1 Separate functional progress animation from decorative motion
...
- [ ] 5.2 Migrate shared transitions and overlays to duration tiers
...
- [ ] 5.3 Migrate component-specific decorative animations
...
- [ ] 6.1 Migrate dialogs, popovers, menus, and floating panels
...
- [ ] 6.2 Migrate cards, toolbars, and raised controls
...
- [ ] 6.3 Author shipped-theme elevation defaults
...
- [ ] 7.1 Add density and elevation controls after their coverage gates pass
...
- [ ] 7.2 Add focus thickness and motion controls under Accessibility
...
- [ ] 7.3 Audit Theme Studio responsive layout and contrast
...
- [ ] 8.1 Add unit and integration regression coverage
...
- [ ] 8.2 Add the shipped-theme Playwright matrix
...
- [ ] 8.3 Complete the final migration audit
...
- [ ] 8.4 Update author and user documentation
...
- [ ] 8.5 Run proportionate final verification
