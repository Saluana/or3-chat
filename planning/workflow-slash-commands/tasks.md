...
-   [x] **2.3 Implement getWorkflowByName function**
...
-   [x] **2.4 Implement getWorkflowById function**
...
-   [x] **3.1 Create WorkflowList component**
...
-   [x] **3.2 Create WorkflowPopover component**
...
-   [x] **3.3 Style components for theme**
...
-   [x] **4.1 Create suggestion configuration**
...
-   [x] **4.2 Implement render lifecycle**
...
-   [x] **4.3 Configure command insertion**
...
-   [x] **5.1 Create workflow-slash-commands.client.ts**

    -   Export defineNuxtPlugin
    -   Add basic plugin structure
    -   Requirements: 1.2

-   [x] **5.2 Register editor extension via hooks**
...
-   [x] **5.3 Register hook types**
    -   Add any new hooks to `app/core/hooks/hook-types.ts`
    -   Requirements: 5.2
    -   Note: Hooks already exist in hook-types.ts

---

## 6. Implement Workflow Execution

-   [x] **6.1 Create parseSlashCommand function**
...
-   [x] **6.2 Create executeWorkflow function**
...
-   [x] **6.3 Create getConversationHistory helper**
...
-   [x] **7.2 Execute workflow on send**
...
-   [x] **7.3 Stream output to chat**

    -   Create streaming assistant message
    -   Update message content on each token
    -   Mark complete when execution finishes
    -   Requirements: 7.2
    -   Note: Basic implementation - streams collected then returned

-   [x] **7.4 Handle execution errors**
