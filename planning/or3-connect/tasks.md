...
- [x] Device authorization protocol and `/connect` confirmation UI.
- [x] Convex device/environment persistence and three-computer default limit.
- [x] AES-GCM credential envelope and hashed lookup tokens.
- [x] Cloudflare named tunnel/DNS provisioning with rollback.
