...
- [x] 13.2 Make rate limit thresholds overridable via runtime config
- [x] 13.3 Make GC retention period configurable via runtime config
- [x] 13.4 Make OpenRouter URL configurable for proxy setups
- [x] 13.5 Make background job timeout configurable
- [x] 13.6 Document all new config options

### 14. Per-user resource limits
> Requirements: 13

- [x] 14.1 Add per-user background job concurrency limit (configurable, default 5)
- [x] 14.2 Add per-workspace storage quota enforcement (configurable, optional)
- [x] 14.3 Write tests for per-user job limiting
- [x] 14.4 Write tests for storage quota rejection
