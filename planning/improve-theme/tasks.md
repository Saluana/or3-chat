...
## 8. Verification
- [x] Run unit tests: `bun run test`. (Requirements: all)
- [x] Smoke-check in dev:
  - [x] Default theme selection logs in dev only.
  - [x] Theme switching rapidly does not duplicate stylesheets.
  - [x] No console unhandled rejection on failed theme import.
  - [x] HMR does not accumulate `page:finish` handlers.
