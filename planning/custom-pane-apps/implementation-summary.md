...
### `.github/chatmodes/retro-agent.chatmode.md` _(updated)_
...
### `.windsurf/rules/or3-agent.md` _(new)_
...
### `app/components/PageShell.vue` _(updated)_
...
### `app/components/PaneUnknown.vue` _(new)_
...
### `app/composables/core/useMultiPane.ts` _(updated heavily)_
...
### `app/composables/core/usePaneApps.ts` _(new)_
...
### `app/plugins/pane-plugin-api.client.ts` _(updated)_
...
### `app/composables/core/__tests__/useMultiPane.test.ts` _(new)_
...
### `app/composables/core/__tests__/usePaneApps.test.ts` _(new)_
...
### `app/components/sidebar/SideBar.vue` _(new)_
...
### `app/components/sidebar/SideNavContent.vue` _(updated)_
...
### `app/components/sidebar/SideNavContentCollapsed.vue` _(updated)_
...
### `app/components/sidebar/SideNavHeader.vue` _(updated)_
...
### `app/components/sidebar/SidebarHeader.vue` _(updated)_
...
### `app/components/sidebar/SideBottomNav.vue` _(updated)_
...
### `app/components/sidebar/SidebarHomePage.vue` _(new)_
...
### `app/components/sidebar/SidebarVirtualList.vue` _(updated)_
...
### `app/components/ResizableSidebarLayout.vue` _(updated)_
...
### `app/components/chat/ChatInputDropper.vue` _(updated)_
...
### `app/components/sidebar/__tests__/SideNavContent.test.ts` _(updated)_
...
### `app/components/sidebar/__tests__/SideNavContentCollapsed.test.ts` _(new)_
...
### `app/composables/sidebar/index.ts` _(new)_
...
### `app/composables/sidebar/useSidebarEnvironment.ts` _(new)_
...
### `app/composables/sidebar/useSidebarPages.ts` _(new)_
...
### `app/composables/sidebar/useActiveSidebarPage.ts` _(new)_
...
### `app/composables/sidebar/useSidebarPageControls.ts` _(new)_
...
### `app/composables/sidebar/registerSidebarPage.ts` _(new)_
...
### `app/composables/sidebar/useSidebarSearch.ts` _(updated)_
...
### `app/composables/sidebar/useSidebarSections.ts` _(updated)_
...
### `app/composables/_registry.ts` _(updated)_
...
### `app/composables/index.ts` _(updated)_
...
### Sidebar composable tests _(new)_
...
### `tests/utils/sidebar-test-helpers.ts` _(new)_
...
### `app/composables/projects/useProjectsCrud.ts` _(updated)_
...
### `app/composables/posts/usePostsList.ts` _(new)_
...
### `app/composables/posts/__tests__/usePostsList.test.ts` _(new)_
...
### `app/plugins/examples/custom-pane-todo-example.client.ts` _(new)_
...
### `app/plugins/examples/snake/SnakeGamePane.vue` _(new)_
...
### `app/plugins/examples/snake/SnakeGameSidebar.vue` _(new)_
...
### `app/plugins/examples/snake/snake-game.ts` _(new)_
...
### `app/plugins/snake-game.client.ts` _(new)_
...
### `app/plugins/sidebar-home-page.client.ts` _(new)_
...
### `app/plugins/__tests__/pane-plugin-api.test.ts` _(new)_
...
### `docs/bundle-health-report.md` _(new)_
...
### `package.json` _(updated)_ & `bun.lockb` _(updated binary)_
...
### `planning/mentions/requirements.md` _(deleted)_
...
### `app/components/sidebar/SidebarHeader.vue`, `app/components/sidebar/SideBottomNav.vue`, `app/components/chat/ChatInputDropper.vue`, `app/components/ResizableSidebarLayout.vue` _(covered above)_.

### `app/components/sidebar/__tests__/SideNavContent.test.ts`, `app/components/sidebar/__tests__/SideNavContentCollapsed.test.ts` _(covered above)_.

### `.github/chatmodes/...`, `.llms/...`, `.windsurf/...` _(covered at top)_.

### `public/_documentation/composables/useSidebarSections.md`, `public/_documentation/composables/useMultiPane.md` _(updated)_
...
### `public/_documentation/types/composables.md` _(updated)_

-   **Function**: Type index.
-   **Why**: Added entries for new composables so doc search finds them.

### `public/_documentation/docmap.json` _(updated)_
...
### `bun.lockb` _(already mentioned with package.json)_
