const galleryButtons =
    'bg-white/10! backdrop-blur-md! hover:bg-white/20! active:bg-white/30! flex items-center justify-center';
...
export const dashboardOverrides = {
    ...
    'selectmenu#dashboard.workspace.logout-policy': {
        ...
        ui: {
            content:
                'z-[30] ring-0! border-[length:var(--md-border-width)]! border-[color:var(--md-border-color)]! rounded-[var(--md-border-radius)] bg-[var(--md-surface)] text-[13px]!',
        },
    },
...
export const dashboardStyles = {
    ...
    '.dashboard-plugin-icon-button:hover': {
        style: {
            ...
            boxShadow:
                '0 0 8px color-mix(in srgb, var(--md-primary) 15%, transparent)',
        },
    },
    ...
    '.section-card': {
        style: {
            ...
            padding: '20px 16px',
            boxShadow:
                'inset 0 1px 0 color-mix(in srgb, var(--md-primary) 10%, transparent)',
        },
    },
};
