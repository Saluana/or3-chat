...
const chatInputButtonConfig = {
    ...
    size: 'sm' as const,
    class: 'min-h-[32px] w-[32px] text-primary flex items-center justify-center p-0 rounded-[var(--md-border-radius-small,var(--md-border-radius))] hover:bg-[var(--md-info-hover)] active:bg-[var(--md-surface-active)] border-[length:var(--md-border-width)] border-[color:var(--md-border-color)]',
};
...
export const chatOverrides = {
    ...
    'div#chat.input-main-container': {
        class: 'border-[length:var(--md-border-width)] border-[color:var(--md-border-color)] rounded-[var(--md-border-radius-large,var(--md-border-radius))] hover:border-[color:var(--md-primary)] focus-within:border-[color:var(--md-primary)] focus-within:ring-1 focus-within:ring-[color:var(--md-primary)] shadow-lg',
    },
    'button#chat.attach': chatInputButtonConfig,
    'button#chat.settings': chatInputButtonConfig,
    'selectmenu#chat.model-select': {
        class: 'h-[var(--app-control-height-small,32px)] border-[length:var(--md-border-width)] border-[color:var(--md-border-color)] rounded-[var(--md-border-radius-small,var(--md-border-radius))] px-2 bg-white dark:bg-gray-800 w-full min-w-[100px] max-w-[320px] ring-0! hover:ring-1! focus-visible:ring-1! cursor-pointer focus-visible:ring-[color:var(--md-primary)]! text-[14px]!',
        ui: {
            base: 'text-[14px]!',
            value: 'text-[14px]!',
        ...
        searchInput: {
            ui: {
                base: 'text-[14px]! rounded-none border-x-0 border-t-0 border-b-[length:var(--md-border-width-subtle,var(--md-border-width))] border-b-[color:var(--md-border-color)]',
            },
        },
    },
    'button.settings': {
        variant: 'basic',
        class: 'rounded-none border-x-0 border-t-0 text-[var(--md-on-surface)] hover:bg-[var(--md-surface-hover)] active:bg-[var(--md-surface-active)] not-last:border-b-[length:var(--md-border-width-subtle,var(--md-border-width))] not-last:border-b-[color:var(--md-border-color)] last:border-b-0 last:rounded-b-[var(--md-border-radius-large,var(--md-border-radius))]',
        ui: {
            label: 'text-[14px]!',
        },
    },
...
export const chatCssSelectors = {
    ...
    '.chat-container-root:not(:first-child)': {
        style: {
            borderTop:
                'var(--md-border-width-subtle, var(--md-border-width)) solid var(--md-border-color) !important',
        },
    },
