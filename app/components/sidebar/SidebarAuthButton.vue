<template>
    <UTooltip
        v-if="!isSsrAuthEnabled || allowUserOverride"
        :text="ariaLabel"
        :delay-duration="0"
        :content="{ side: 'right' }"
    >
    ...
    <UTooltip
        ...
        :content="{ side: 'right' }"
    >
        <div class="sidebar-auth-adapter flex items-center justify-center">
...
const connectionLabel = computed(() => {
    ...
    if (usingInstanceKey.value && !isConnected.value) return 'Connect';
