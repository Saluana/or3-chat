<template>
    <div v-if="docs.length > 0" class="mt-4">
        ...
        <div v-else class="space-y-2">
            ...
            >
                ...
                <!-- Actions popover (mirrors chat threads style) -->
                <UPopover
                    :content="{ side: 'right', align: 'start', sideOffset: 6 }"
                >
                    <span
                        class="inline-flex items-center justify-center w-5 h-5 rounded-[3px] hover:bg-black/10 active:bg-black/20 ml-2 shrink-0"
                        @click.stop
                    >
                        <UIcon
