<template>
    <div
        ...
        role="button"
        tabindex="0"
        class="w-full group flex items-center gap-2 px-3 py-2.5 group relative transition-colors duration-200 rounded-[var(--md-border-radius)] cursor-pointer animate-sidebar-item-enter unified-sb-item theme-btn"
        :class="{
