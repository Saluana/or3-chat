...
import { useTaskListService } from './tasks/composables/useTaskListService';
...
export default defineNuxtPlugin(() => {
    ...
    const openTaskListInActivePane = async (listId: string) => {
        ...
        await multiPaneApi.setPaneApp(index, 'or3-tasks', { recordId: listId });
    };
