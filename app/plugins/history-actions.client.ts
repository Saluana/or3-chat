...
export function setupHistoryActionsExample() {
    // Use hook effect so the registration is cleaned up on HMR/unmount
    useHookEffect('examples.history-actions', () => {
...
// Auto-run when plugin file is imported in client builds
