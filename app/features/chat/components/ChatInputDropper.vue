...
import { validateFile, persistAttachment } from '../utils/file-upload-utils';
...
import { useUserApiKey } from '@core/auth';
...
import {
    registerPaneInput,
    unregisterPaneInput,
} from '@features/chat/composables/useChatInputBridge';
import {
    useComposerActions,
