<template>
    ...
    >
        ...
        <div ref="bottomNavRef" class="shrink-0 pb-2 flex flex-col gap-2">
            ...
            <SideBottomNav @toggle-dashboard="emit('toggleDashboard')" />
        </div>
...
import SidebarVirtualList from '@features/sidebar/components/SidebarVirtualList.vue';
import SideNavHeader from '@features/sidebar/components/SideNavHeader.vue';
import { liveQuery } from 'dexie';
import { db, upsert, del as dbDel, create, type Post, type Project } from '@db'; // Dexie + barrel helpers
import { nowSec, newId } from '@db/util';
import { updateDocument } from '@db/documents';
import { loadDocument } from '@features/documents/composables/useDocumentsStore';
import { useProjectsCrud } from '@features/projects/composables/useProjectsCrud';
import {
...
import { useSidebarSearch } from '@features/sidebar/composables/useSidebarSearch';
