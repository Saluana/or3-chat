export const DEFAULT_ICONS = {
    ...
    // External Agents
    'external-agent.bot': 'pixelarticons:android',
    'external-agent.connect': 'pixelarticons:zap',
    'external-agent.disconnect': 'pixelarticons:zap-off',
    'external-agent.key': 'pixelarticons:lock',
    'external-agent.install': 'pixelarticons:monitor',
    'external-agent.package': 'pixelarticons:package',
    'external-agent.server': 'pixelarticons:server',
    'external-agent.server.off': 'pixelarticons:cloud-server',
    'external-agent.network': 'pixelarticons:wifi',
    'external-agent.tag': 'pixelarticons:label',
    'external-agent.link': 'pixelarticons:link',
    'external-agent.link.off': 'pixelarticons:unlink',
    'external-agent.search.empty': 'pixelarticons:search',
    'external-agent.file': 'pixelarticons:file',
    'external-agent.file.text': 'pixelarticons:file-text',
    'external-agent.file.audio': 'pixelarticons:audio-device',
    'external-agent.file.video': 'pixelarticons:video',
    'external-agent.file.pdf': 'pixelarticons:file-alt',
    'external-agent.file.diff': 'pixelarticons:file-flash',
    'external-agent.drop': 'pixelarticons:cloud-upload',
    'external-agent.shield.alert': 'pixelarticons:warning-box',
    'external-agent.shield.check': 'pixelarticons:shield',
