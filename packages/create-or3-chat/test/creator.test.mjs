...
test('Docker manifest preparation prunes inactive providers and replaces pinned custom providers', () => {
    ...
    assert.equal(manifest.dependencies['or3-provider-basic-auth'], '0.0.9');
...
test('generated template has registry-clean first-party dependencies', async () => {
    ...
    assert.equal(providerVersions['or3-provider-basic-auth'], '0.0.9');
    ...
    assert.equal(manifest.dependencies['@or3/intern-client'], '0.1.3');
    assert.equal(manifest.dependencies['or3-provider-basic-auth'], '0.0.9');
