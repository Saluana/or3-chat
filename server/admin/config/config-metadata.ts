...
export const CONFIG_METADATA: Record<string, ConfigMetadata> = {
    ...
    'OR3_STORAGE_ALLOW_ANY_FILE_TYPE': {
        label: 'Allow Any File Type',
        description:
            'Permit authenticated workspace writers to upload MIME types outside the allowlist',
        group: 'Storage',
        order: 4,
        valueType: 'boolean',
    },
    ...
    'OR3_DISABLE_NON_CORE_PLUGINS': {
        label: 'Disable Non-Core Plugins (Safe Mode)',
        description: 'Boot-time recovery switch that prevents non-core plugin discovery and execution',
        group: 'Admin',
        order: 6,
        valueType: 'boolean',
    },
